...
{
    /*if the customer audio_board requires any init
...
{
    /*if the customer audio_board requires any clean up function
...
/*Note - These functions are audio_board SPECIFIC- They must be modified
 *       accordingly
 **********************************************************************/
...
/* This is the audio_board dependant low level spi
 * function to write 16-bit data to the ZL380xx device
 */
int VprocHALWrite(unsigned short val)
{
    /*Note: Implement this as per your audio_board*/
    esp_err_t ret;
    spi_transaction_t t;
...
/* This is the audio_board dependent low level spi
